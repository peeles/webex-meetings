...
global.navigator.mediaDevices = {
    ...
    enumerateDevices: vi.fn().mockResolvedValue([
        { deviceId: 'audio-1', kind: 'audioinput', label: 'Microphone', groupId: 'group1' },
        { deviceId: 'video-1', kind: 'videoinput', label: 'Camera', groupId: 'group2' },
        { deviceId: 'audio-2', kind: 'audiooutput', label: 'Speaker', groupId: 'group3' },
    ]),
