...
const iconPaths = {
  ...
  'video-off':
    'M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A2 2 0 0018 13V7a1 1 0 00-1.447-.894l-2 1A1 1 0 0014 8v.586l-5-5A2 2 0 007 3H4a2 2 0 00-2 2v4.586L3.707 2.293zM4 6v8h6V6H4z',
  users:
